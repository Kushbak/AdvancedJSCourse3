...
window.addEventListener('DOMContentLoaded', function () {
  ...
  showUpSlider.init(); // TODO: остановка автоплэя при наведении и исключение кнопок из container правильным способом
  ...
  new _modules_download__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').init(); // TODO: Исправить переход на первый модуль после скачивания
});
  ...
  _createClass(Form, [{
    ...
    value: function initMask() {
      ...
      inputs.forEach(function (input) {
        ...
        input.addEventListener('focus', createMask); // input.addEventListener('blur', createMask)
      });
    }
  }, {
    key: "clearInputs",
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    key: "decorizeSliders",
    value: function decorizeSliders() {
      var _this = this;
